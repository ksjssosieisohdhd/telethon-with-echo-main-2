...
bot_token = "7755260486:AAFqDys3HPszR458Q_C5o4tO5OZ5SVbQ-KI"
running_processes = {}
try:
...
if "token" not in info:
    while (True):
        bot_token = input("Enter the bot token :7755260486:AAFqDys3HPszR458Q_C5o4tO5OZ5SVbQ-KI ")
    ...
    bot_token = info["7755260486:AAFqDys3HPszR458Q_C5o4tO5OZ5SVbQ-KI"]

if "sudo" not in info:
    info["sudo"] = str(input("Enter the your telegram ID :7044628644 "))
    info["admins"] = {}
    with open("echo_data.json", "w") as json_file:
        json.dump(info, json_file)
